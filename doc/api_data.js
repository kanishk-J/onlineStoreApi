define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example Usage:",
        "content": "curl -X POST http://localhost:4000/api/products/findById/59fc9d144116f409f4e4ef42",
        "type": "curl"
      }
    ],
    "parameter": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example Usage:",
        "content": "curl -X POST http://localhost:4000/api/products/findByName/Motorola Moto G5 plus",
        "type": "curl"
      }
    ],
    "parameter": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example Usage:",
        "content": "curl -X POST http://localhost:4000/api/users/59fc9d144116f409f4e4ef42",
        "type": "curl"
      }
    ],
    "parameter": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example Usage:",
        "content": "curl -X POST http://localhost:4000/api/users/me?access-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1OWZjYWQzZTE4MTI2MjIyYmNhODA5MjEiLCJpYXQiOjE1MDk3MzE2NDYsImV4cCI6MTUwOTgxODA0Nn0.TJSxLJ_hwVvs70Q00bmKtlEFwlaU6OdTZ9ClAK_h33o",
        "type": "curl"
      }
    ],
    "parameter": {
